  ...
  const [chatHistories, setChatHistories] = useState<ChatHistory[]>([
    {
      ...
      messages: [
        {
          id: '1',
          content: "Hello! I'm your AI assistant. I can help you with pet adoption questions, finding the right pet for your lifestyle, understanding pet care, and much more. How can I assist you today?",
          sender: 'ai',
          timestamp: new Date()
        }
      ],
